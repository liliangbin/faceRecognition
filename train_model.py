...
class Model(object):
    ...
    def build_model(self):
        ...
        print(self.dataset.X_train.shape[1:])
        ...
        self.model.add(Dropout(0.3))  # 6 Dropout层
        ...
        self.model.add(Dropout(0.4))  # 12 Dropout层
    ...
    def train_model(self):
        ...
        #
        # train_history = self.model.fit_generator(datagen.flow(dataset.X_train, dataset.Y_train,
        #                                                       batch_size=64),
        ...
        train_history = self.model.fit(self.dataset.X_train, self.dataset.Y_train, validation_split=0.2, epochs=100,
                                       batch_size=20)
